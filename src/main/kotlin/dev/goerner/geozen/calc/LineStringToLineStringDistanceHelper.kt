 ...
 *
 * Intersection detection is handled by [GeometricUtils.doPolylineSegmentsIntersect]. This object
 * provides only the bidirectional distance helper that is common to both
