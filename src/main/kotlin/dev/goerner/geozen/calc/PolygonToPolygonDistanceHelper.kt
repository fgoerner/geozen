...
internal object PolygonToPolygonDistanceHelper {
    ...
    sealed class AnalysisResult {
        ...
        /**
         * Polygon1 has vertices inside a hole of Polygon2 - need to calculate distance to hole
         * boundary
         */
        data class Polygon1InHoleOfPolygon2(val holeRing: List<Position>) : AnalysisResult()

        /**
         * Polygon2 has vertices inside a hole of Polygon1 - need to calculate distance to hole
         * boundary
         */
    ...
    fun analyzePolygonPolygonRelationship(
        ...
        when (
            val r =
                GeometricUtils.checkVertexContainment(exteriorRing1, exteriorRing2, interiorRings2)
        ) {
            is GeometricUtils.VertexContainmentResult.FullyContained ->
                return AnalysisResult.Polygon1ContainedInPolygon2
            is GeometricUtils.VertexContainmentResult.InHole ->
                return AnalysisResult.Polygon1InHoleOfPolygon2(r.holeRing)
        ...
        when (
            val r =
                GeometricUtils.checkVertexContainment(exteriorRing2, exteriorRing1, interiorRings1)
        ) {
            is GeometricUtils.VertexContainmentResult.FullyContained ->
                return AnalysisResult.Polygon2ContainedInPolygon1
            is GeometricUtils.VertexContainmentResult.InHole ->
                return AnalysisResult.Polygon2InHoleOfPolygon1(r.holeRing)
            is GeometricUtils.VertexContainmentResult.NotContained -> Unit // continue
        }
