 ...
 *
 * @param longitude The longitude in the unit of the [CoordinateReferenceSystem] of its containing
 *   geometry
 * @param latitude The latitude in the unit of the [CoordinateReferenceSystem] of its containing
 *   geometry
...
data class Position
@JvmOverloads
constructor(val longitude: Double, val latitude: Double, val altitude: Double = 0.0) {
    init {
