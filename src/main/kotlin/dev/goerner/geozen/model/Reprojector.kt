...
internal object Reprojector {
    ...
    private fun toWgs84(pos: Position, crs: CoordinateReferenceSystem): Position =
        when (crs) {
            ...
            CoordinateReferenceSystem.WEB_MERCATOR ->
                Position(
                    ...
                    Math.toDegrees(
                        2.0 * atan(exp(pos.latitude / EARTH_RADIUS_METERS)) - Math.PI / 2.0
                    ),
                    pos.altitude,
                )
        }

    private fun toWebMercator(pos: Position, crs: CoordinateReferenceSystem): Position =
        when (crs) {
            ...
            CoordinateReferenceSystem.WGS_84 -> {
                ...
                Position(
                    ...
                    EARTH_RADIUS_METERS *
                        ln(tan(Math.PI / 4.0 + Math.toRadians(pos.latitude) / 2.0)),
                    pos.altitude,
                )
            }
        }
