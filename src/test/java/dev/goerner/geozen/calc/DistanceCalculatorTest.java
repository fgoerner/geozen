...
public class DistanceCalculatorTest {
    ...
    void testApproximateDistance() {
        ...
        double approximateDistance = DistanceCalculator.approximateDistance(p1, p2);
    ...
    void testPreciseDistance() {
        ...
        double preciseDistance = DistanceCalculator.preciseDistance(p1, p2);
    ...
    void testApproximateDistanceLineString() {
        ...
        double approximateDistance = DistanceCalculator.approximateDistance(p1, lineString);

        assertEquals(1832.5414860629317, approximateDistance);
    }

    @Test
    void testPreciseDistanceLineString() {
        Point p1 = new Point(11.4694, 49.2965);
        LineString lineString = new LineString(
                List.of(
                        new Position(11.4432, 49.3429),
        ...
        double preciseDistance = DistanceCalculator.preciseDistance(p1, lineString);
