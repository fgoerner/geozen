...
class PreciseDistanceCalculatorTest :
    FunSpec({
        ...
        test(
            ...
            // when
            val preciseDistance = PreciseDistanceCalculator.calculate(polygon, multiLineString)
        ...
        test("Polygon to MultiLineString distance - empty MultiLineString throws exception") {
            ...
            val exception =
                shouldThrow<IllegalArgumentException> {
                    PreciseDistanceCalculator.calculate(polygon, emptyMultiLineString)
                }
            exception.message shouldBe
                "MultiLineString must contain at least one LineString to calculate distance, but contained 0"
        }
        ...
        test(
            ...
            // when
            val preciseDistance = PreciseDistanceCalculator.calculate(lineString, multiLineString)
        ...
        test("LineString to MultiLineString distance - empty MultiLineString throws exception") {
            ...
            val exception =
                shouldThrow<IllegalArgumentException> {
                    PreciseDistanceCalculator.calculate(lineString, emptyMultiLineString)
                }
            exception.message shouldBe
                "MultiLineString must contain at least one LineString to calculate distance, but contained 0"
        }
        ...
        test("LineString to MultiPolygon distance - returns minimum distance to closest polygon") {
            ...
            // when
            val preciseDistance = PreciseDistanceCalculator.calculate(lineString, multiPolygon)
        ...
        test("LineString to MultiPolygon distance - empty MultiPolygon throws exception") {
            ...
            val exception =
                shouldThrow<IllegalArgumentException> {
                    PreciseDistanceCalculator.calculate(lineString, emptyMultiPolygon)
                }
            exception.message shouldBe
                "MultiPolygon must contain at least one Polygon to calculate distance, but contained 0"
        }
        ...
        test(
            ...
            // when
            val preciseDistance = PreciseDistanceCalculator.calculate(polygon, multiPolygon)
        ...
        test("Polygon to MultiPolygon distance - empty MultiPolygon throws exception") {
            ...
            val exception =
                shouldThrow<IllegalArgumentException> {
                    PreciseDistanceCalculator.calculate(polygon, emptyMultiPolygon)
                }
            exception.message shouldBe
                "MultiPolygon must contain at least one Polygon to calculate distance, but contained 0"
        }
        ...
        test(
            ...
            // when
            val preciseDistance =
                PreciseDistanceCalculator.calculate(multiLineString1, multiLineString2)
        ...
        test("MultiPoint to MultiPolygon distance - single point to single polygon") {
            ...
            // when
            val preciseDistance = PreciseDistanceCalculator.calculate(multiPoint, multiPolygon)
        ...
        test("MultiPoint to MultiPolygon distance - symmetric result via geometry dispatch") {
            ...
            // when
            val forwardDistance = multiPoint.exactDistanceTo(multiPolygon)
            val reverseDistance = multiPolygon.exactDistanceTo(multiPoint)
        ...
        test("MultiPoint to MultiPolygon distance - empty MultiPoint throws exception") {
            ...
            val exception =
                shouldThrow<IllegalArgumentException> {
                    PreciseDistanceCalculator.calculate(emptyMultiPoint, multiPolygon)
                }
            exception.message shouldBe
                "MultiPoint must contain at least one point to calculate distance, but contained 0"
        }
        ...
        test("MultiPoint to MultiPolygon distance - empty MultiPolygon throws exception") {
            ...
            val exception =
                shouldThrow<IllegalArgumentException> {
                    PreciseDistanceCalculator.calculate(multiPoint, emptyMultiPolygon)
                }
            exception.message shouldBe
                "MultiPolygon must contain at least one Polygon to calculate distance, but contained 0"
        }
        ...
        test("GeometryCollection to Point distance - single Point member") {
            ...
            // when
            val preciseDistance = PreciseDistanceCalculator.calculate(gc, point)
        ...
        test("GeometryCollection to Polygon distance - LineString member fully inside polygon") {
            ...
            // when
            val preciseDistance = PreciseDistanceCalculator.calculate(gc, polygon)
        ...
        test("GeometryCollection to GeometryCollection distance - single member each") {
            ...
            // when
            val preciseDistance = PreciseDistanceCalculator.calculate(gc1, gc2)
        ...
        test("GeometryCollection distance - symmetric result via exactDistanceTo") {
            ...
            // when
            val forwardDistance = gc.exactDistanceTo(polygon)
            val reverseDistance = polygon.exactDistanceTo(gc)
        ...
        test("GeometryCollection to Point distance - empty GeometryCollection throws exception") {
            ...
            val exception =
                shouldThrow<IllegalArgumentException> {
                    PreciseDistanceCalculator.calculate(emptyGc, point)
                }
            exception.message shouldBe
        ...
        test("GeometryCollection to GeometryCollection distance - first empty throws exception") {
            ...
            val exception =
                shouldThrow<IllegalArgumentException> {
                    PreciseDistanceCalculator.calculate(emptyGc, gc)
                }
            exception.message shouldBe
                "GeometryCollection must contain at least one geometry to calculate distance, but contained 0"
        }
        ...
        test("GeometryCollection to GeometryCollection distance - second empty throws exception") {
            ...
            val exception =
                shouldThrow<IllegalArgumentException> {
                    PreciseDistanceCalculator.calculate(gc, emptyGc)
                }
            exception.message shouldBe
                "GeometryCollection must contain at least one geometry to calculate distance, but contained 0"
        }

        test("GeometryCollection to Point distance - nested GeometryCollection") {
            // given
            ...
            // when
            val preciseDistance = PreciseDistanceCalculator.calculate(outerGc, point)
