...
class ApproximateDistanceCalculatorTest : FunSpec({
    ...
    test("MultiLineString to MultiPolygon distance - single LineString to single polygon") {
        ...
        //when
        val approximateDistance = ApproximateDistanceCalculator.calculate(multiLineString, multiPolygon)
    ...
    test("MultiPolygon to MultiPolygon distance - single polygon in each MultiPolygon") {
        ...
        //when
        val approximateDistance = ApproximateDistanceCalculator.calculate(multiPolygon1, multiPolygon2)
