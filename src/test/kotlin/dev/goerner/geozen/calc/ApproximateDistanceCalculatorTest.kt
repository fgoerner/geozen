...
class ApproximateDistanceCalculatorTest :
    FunSpec({
        ...
        test("LineString to LineString distance - non-intersecting") {
            ...
            // when
            val approximateDistance =
                ApproximateDistanceCalculator.calculate(lineString1, lineString2)
        ...
        test(
            "LineString to Polygon distance - LineString completely contained in hole without touching"
        ) {
            // given
            val lineString =
                LineString(
                ...
                LineString(
                    listOf(
                        ...
                        Position(
                            11.65,
                            49.3,
                        ), // Segment passes through polygon vertex at (11.5, 49.3)
                    )
                )
            val polygon =
                Polygon(
        ...
        test(
            "LineString to Polygon distance - LineString in non-convex hole with protruding vertex"
        ) {
            // given
                    ...
                    listOf(
                        ...
                        listOf(
                            ...
                            Position(
                                11.55,
                                49.352,
                            ), // This vertex protrudes very close to the LineString
                            Position(11.52, 49.38),
                            Position(11.52, 49.32),
                        ),
                    )
            ...
            // then
            // The minimum distance should be from the protruding hole vertex to the LineString
            // segment
        ...
        test("Polygon to Polygon distance - polygon inside hole of another polygon") {
            ...
            // Closest distance is from polygon2's edge at (11.55, 49.35) to hole boundary at
            // (11.52,
            // 49.35)
        ...
        test(
            "Point to MultiPoint distance - point coincides with one of the multi-point positions"
        ) {
            // given
        ...
        test("Point to MultiPoint distance - single point in multi-point") {
            // given
            val point = Point(11.5, 49.3)
            val multiPoint = MultiPoint(listOf(Position(11.6, 49.4)))
        ...
        test("Point to MultiLineString distance - point intersects one of the linestrings") {
            ...
            // when
            val approximateDistance =
                ApproximateDistanceCalculator.calculate(point, multiLineString)
        ...
        test("LineString to MultiPoint distance - returns minimum distance to closest point") {
                ...
                MultiPoint(
                    listOf(
                        Position(
                            11.4694,
                            49.2965,
                        ), // closest point – same as in "Point to LineString distance" test
            ...
            // when
            val approximateDistance =
                ApproximateDistanceCalculator.calculate(lineString, multiPoint)
        ...
        test(
            "LineString to MultiPoint distance - point coinciding with LineString vertex returns 0"
        ) {
            // given
            val lineString =
                LineString(
                ...
                MultiPoint(
                    listOf(
                        Position(
                            11.4694,
                            49.2965,
                        ), // closest – same as in "Point to Polygon distance - point outside
                        // polygon"
                ...
                MultiPoint(
                    listOf(
                        Position(
                            11.4694,
                            49.2965,
                        ) // same as in "Point to Polygon distance - point outside polygon"
                    )
                )
        ...
        test(
            "Polygon to MultiLineString distance - returns minimum distance to closest LineString"
        ) {
            // given
            val polygon =
                Polygon(
            ...
            val multiLineString =
                MultiLineString(
                    listOf(
                        ...
                        listOf( // close LineString – same as in "LineString to Polygon distance -
            ...
            // when
            val approximateDistance =
                ApproximateDistanceCalculator.calculate(polygon, multiLineString)
        ...
        test(
            "Polygon to MultiLineString distance - LineString intersects polygon boundary returns 0.0"
        ) {
            // given
            val polygon =
                Polygon(
        ...
        test("Polygon to MultiLineString distance - single LineString in MultiLineString") {
            ...
            val multiLineString =
                MultiLineString(
                    listOf(
                        listOf( // same as in "LineString to Polygon distance - LineString outside
                            // polygon"
                            Position(11.4, 49.3),
                            Position(11.45, 49.35),
                        )
        ...
        test(
            "LineString to MultiLineString distance - returns minimum distance to closest LineString"
        ) {
            // given
            val lineString =
                LineString(
            ...
            val multiLineString =
                MultiLineString(
                    listOf(
                        ...
                        listOf( // close LineString – same as in "LineString to LineString distance
                            // -
                            // non-intersecting"
                            Position(11.6, 49.3),
                            Position(11.7, 49.35),
            ...
            // when
            val approximateDistance =
                ApproximateDistanceCalculator.calculate(lineString, multiLineString)
        ...
        test(
            "LineString to MultiLineString distance - LineString intersects one of the member LineStrings"
        ) {
            // given
        ...
        test("LineString to MultiPolygon distance - returns minimum distance to closest polygon") {
            ...
            val multiPolygon =
                MultiPolygon(
                    listOf(
                        ...
                        listOf( // close polygon – same as in "LineString to Polygon distance -
                            // LineString outside polygon"
                            listOf(
                                Position(11.5, 49.3),
                                Position(11.6, 49.3),
            ...
            // when
            val approximateDistance =
                ApproximateDistanceCalculator.calculate(lineString, multiPolygon)
        ...
        test(
            "LineString to MultiPolygon distance - LineString intersects one of the member polygons"
        ) {
            // given
            val lineString =
                LineString(
        ...
        test(
            "Polygon to MultiPolygon distance - polygon outside all polygons, closest member wins"
        ) {
            // given
            val polygon =
                Polygon(
            ...
            // then
            // Minimum distance is to the closer polygon - same as Polygon-to-Polygon disjoint
            // result
            approximateDistance shouldBe 7236.288600808812
        }
        ...
        test(
            "Polygon to MultiPolygon distance - polygon fully inside one polygon in MultiPolygon"
        ) {
            // given
            val polygon =
                Polygon(
        ...
        test(
            "Polygon to MultiPolygon distance - one polygon in MultiPolygon fully inside test polygon"
        ) {
            // given
            val polygon =
                Polygon(
        ...
        test("MultiPoint to MultiPoint distance - two single-point MultiPoints") {
            // given
            val multiPoint1 = MultiPoint(listOf(Position(11.5, 49.3)))
            val multiPoint2 = MultiPoint(listOf(Position(11.6, 49.4)))

            // when
            val approximateDistance =
                ApproximateDistanceCalculator.calculate(multiPoint1, multiPoint2)
        ...
        test("MultiPoint to MultiPoint distance - empty first MultiPoint throws exception") {
            // given
            val emptyMultiPoint = MultiPoint(emptyList())
            val multiPoint = MultiPoint(listOf(Position(11.5, 49.3)))
        ...
        test("MultiPoint to MultiLineString distance - single point to single linestring") {
            ...
            // when
            val approximateDistance =
                ApproximateDistanceCalculator.calculate(multiPoint, multiLineString)
        ...
        test("MultiPoint to MultiLineString distance - point at vertex returns 0.0") {
            // given
            val multiPoint = MultiPoint(listOf(Position(11.6, 49.3)))
            val multiLineString =
                MultiLineString(
                    listOf(
                        listOf(
        ...
        test(
            "MultiPoint to MultiLineString distance - returns minimum distance across all points and linestrings"
        ) {
            // given
            val multiPoint =
                MultiPoint(
        ...
        test(
            "MultiLineString to MultiLineString distance - single LineString in each MultiLineString"
        ) {
            // given
            ...
            // when
            val approximateDistance =
                ApproximateDistanceCalculator.calculate(multiLineString1, multiLineString2)
        ...
        test(
            "MultiLineString to MultiLineString distance - returns minimum distance across all line string combinations"
        ) {
            // given
            // Minimum distance is between LS_A and LS_C (≈ 1112 m apart); all other pairs are much
            // further
            val multiLineString1 =
                MultiLineString(
                    listOf(
        ...
        test(
            "MultiLineString to MultiLineString distance - symmetric result via geometry dispatch"
        ) {
            // given
            val multiLineString1 =
                MultiLineString(
        ...
        test(
            "MultiLineString to MultiLineString distance - empty first MultiLineString throws exception"
        ) {
            // given
            val emptyMultiLineString = MultiLineString(emptyList())
            val multiLineString =
        ...
        test(
            "MultiLineString to MultiLineString distance - empty second MultiLineString throws exception"
        ) {
            // given
            val multiLineString =
                MultiLineString(
        ...
        test("MultiPoint to MultiPolygon distance - single point to single polygon") {
            // given
            val multiPoint = MultiPoint(listOf(Position(11.4694, 49.2965)))
            val multiPolygon =
                MultiPolygon(
                    listOf(
                        listOf(
            ...
            // when
            val approximateDistance =
                ApproximateDistanceCalculator.calculate(multiPoint, multiPolygon)
        ...
        test("MultiPoint to MultiPolygon distance - point inside polygon returns 0.0") {
            // given
            val multiPoint = MultiPoint(listOf(Position(11.55, 49.35)))
            val multiPolygon =
                MultiPolygon(
                    listOf(
                        listOf(
        ...
        test(
            "MultiPoint to MultiPolygon distance - returns minimum distance across all points and polygons"
        ) {
            // given
            val multiPoint =
                MultiPoint(
        ...
        test("MultiLineString to MultiPolygon distance - single LineString to single polygon") {
            ...
            // when
            val approximateDistance =
                ApproximateDistanceCalculator.calculate(multiLineString, multiPolygon)
        ...
        test(
            "MultiLineString to MultiPolygon distance - LineString intersects polygon returns 0.0"
        ) {
            // given
            val multiLineString =
                MultiLineString(
        ...
        test(
            "MultiLineString to MultiPolygon distance - returns minimum distance across all line string and polygon combinations"
        ) {
            // given
        ...
        test("MultiLineString to MultiPolygon distance - symmetric result via geometry dispatch") {
            ...
            // when
            val forwardDistance = multiLineString.fastDistanceTo(multiPolygon)
            val reverseDistance = multiPolygon.fastDistanceTo(multiLineString)
        ...
        test("MultiLineString to MultiPolygon distance - empty MultiLineString throws exception") {
            ...
            val exception =
                shouldThrow<IllegalArgumentException> {
                    ApproximateDistanceCalculator.calculate(emptyMultiLineString, multiPolygon)
                }
            exception.message shouldBe
                "MultiLineString must contain at least one LineString to calculate distance, but contained 0"
        }
        ...
        test("MultiLineString to MultiPolygon distance - empty MultiPolygon throws exception") {
            ...
            val exception =
                shouldThrow<IllegalArgumentException> {
                    ApproximateDistanceCalculator.calculate(multiLineString, emptyMultiPolygon)
                }
            exception.message shouldBe
                "MultiPolygon must contain at least one Polygon to calculate distance, but contained 0"
        }
        ...
        test("MultiPolygon to MultiPolygon distance - single polygon in each MultiPolygon") {
            ...
            // when
            val approximateDistance =
                ApproximateDistanceCalculator.calculate(multiPolygon1, multiPolygon2)
        ...
        test(
            "MultiPolygon to MultiPolygon distance - one polygon fully inside another returns 0.0"
        ) {
            // given
            val multiPolygon1 =
                MultiPolygon(
        ...
        test(
            "MultiPolygon to MultiPolygon distance - returns minimum distance across all polygon combinations"
        ) {
            // given
        ...
        test("MultiPolygon to MultiPolygon distance - symmetric result via geometry dispatch") {
            ...
            // when
            val forwardDistance = multiPolygon1.fastDistanceTo(multiPolygon2)
            val reverseDistance = multiPolygon2.fastDistanceTo(multiPolygon1)
        ...
        test("MultiPolygon to MultiPolygon distance - empty first MultiPolygon throws exception") {
            ...
            val exception =
                shouldThrow<IllegalArgumentException> {
                    ApproximateDistanceCalculator.calculate(emptyMultiPolygon, multiPolygon)
                }
            exception.message shouldBe
                "MultiPolygon must contain at least one Polygon to calculate distance, but contained 0"
        }
        ...
        test(
            "GeometryCollection to Point distance - Point member inside Polygon member, closest member wins"
        ) {
            // given
        ...
        test(
            "GeometryCollection to MultiLineString distance - Point member on one of the linestrings"
        ) {
            // given
        ...
        test(
            "GeometryCollection to MultiPolygon distance - single Point member outside all polygons"
        ) {
            // given
        ...
        test(
            "GeometryCollection to GeometryCollection distance - mixed members, one pair yields 0.0"
        ) {
            // given
        ...
        test(
            "GeometryCollection to GeometryCollection distance - returns minimum across all member pairs"
        ) {
            // given
            ...
            // then
            // Minimum is between close polygon in gc1 and the polygon in gc2 - same as Polygon to
            // Polygon disjoint
            approximateDistance shouldBe 7236.288600808812
        }
