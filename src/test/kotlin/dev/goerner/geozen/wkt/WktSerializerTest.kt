...
class WktSerializerTest :
    FunSpec({
        ...
        test("serialize MultiPoint single") {
            // given
            val multiPoint = MultiPoint(listOf(Position(10.0, 20.0)))
        ...
        test("serialize MultiLineString single") {
            ...
            val multiLineString =
                MultiLineString(
                    listOf(listOf(Position(10.0, 20.0), Position(30.0, 40.0), Position(50.0, 60.0)))
                )
        ...
        test("serialize MultiLineString EWKT") {
            ...
            val multiLineString =
                MultiLineString(
                    listOf(listOf(Position(10.0, 20.0), Position(30.0, 40.0))),
                    CoordinateReferenceSystem.WGS_84,
                )
            ...
            val collection =
                GeometryCollection(
                    listOf(
                        ...
                        MultiLineString(listOf(listOf(Position(10.0, 20.0), Position(30.0, 40.0)))),
                    )
                )
