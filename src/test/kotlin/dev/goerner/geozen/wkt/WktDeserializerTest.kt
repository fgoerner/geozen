...
class WktDeserializerTest :
    FunSpec({
        ...
        test("deserialize GeometryCollection EWKT") {
            ...
            collection.geometries[0].coordinateReferenceSystem shouldBe
                CoordinateReferenceSystem.WEB_MERCATOR
            collection.geometries[1].coordinateReferenceSystem shouldBe
                CoordinateReferenceSystem.WEB_MERCATOR
        }
        ...
        test("deserialize GeometryCollection EWKT with multi geometries") {
            ...
            multiLineString.coordinateReferenceSystem shouldBe
                CoordinateReferenceSystem.WEB_MERCATOR
